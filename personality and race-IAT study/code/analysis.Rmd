...
ggplot(data_processed_after_exclusions, aes(x = bfi_e_mean)) +
  geom_histogram(binwidth = 1, 
                 fill = viridis_pal(begin = 0.5, option = "mako")(1), 
                 color = viridis_pal(begin = 0.30, option = "mako")(1)) + 
  xlab("Mean extroversion") +
  ylab("Frequency") +
  theme_linedraw() +
  scale_x_continuous(breaks = pretty_breaks(n = 10))+
 ggtitle("Distribution of extroversion")
...
ggplot(data_processed_after_exclusions, aes(x = bfi_c_mean)) +
  ...
  ggtitle("Distribution of conscientiousness")
...
ggplot(data_processed_after_exclusions, aes(x = bfi_a_mean)) +
  ...
  scale_y_continuous(breaks = seq(0, 10, by = 2),
                     labels = as.character(seq(0, 10, by = 2))) + 
 ggtitle("Distribution of agreeableness")
...
ggplot(data_processed_after_exclusions, aes(x = iat_D)) +
  ...
  theme_linedraw() +
  scale_x_continuous(breaks = pretty_breaks(n = 10))+
 ggtitle("Distribution of IAT scores")
